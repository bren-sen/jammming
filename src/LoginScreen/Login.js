...
function Login({clientId, redirectUrl, authorizationEndpoint, tokenEndpoint, scope, currentToken, redirectToSpotifyAuthorize, getToken, refreshToken, getUserData, loginWithSpotifyClick, logoutClick}) {
